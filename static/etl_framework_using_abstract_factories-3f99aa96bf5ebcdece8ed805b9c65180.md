...
class Extract(metaclass=ABCMeta):
    ...
    def __init__(self):
        print('initializiing an instance of extractor for class ', self.__class__)

    def extract(self):
        return self._extract()

    @abstractmethod # this is the method which has to be defined in all the concrete classes
    def _extract(self):
