...
Testing to see if the blog works as expected by adding ads from <a href="https://chitika.com">Chitika</a>. All of this is done by setting html in the `<div>...</div>` tag of the post.
