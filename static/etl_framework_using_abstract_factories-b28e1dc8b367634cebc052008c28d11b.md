...
In order for them to be abstraction, we have to `import abc`. `abc` is the library for creating abstract classes in python. [ABC](https://docs.python.org/3.7/library/abc.html)