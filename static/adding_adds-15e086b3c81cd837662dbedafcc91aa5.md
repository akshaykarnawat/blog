...
Testing to see if the blog works as expected by adding ads from <a href="chitika.com">chitika.com</a>. All of this is done by setting html in the `<div>...</div>` tag of the post.
